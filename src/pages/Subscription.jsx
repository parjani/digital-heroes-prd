                        ...
                        <div className="flex flex-col lg:flex-row lg:items-stretch gap-px bg-[#cfd4c8] border border-[#cfd4c8]">
                            ...
                            <div className="flex-1 bg-[#dfe5da] p-7 md:p-9">
                                ...
                                <div className="mt-7 flex items-end gap-4">
                                    ...
                                    <span
                                        className={`mb-1 w-2.5 h-2.5 ${subscription?.status === "active"
                                                ? "bg-[#47775f]"
                                                : "bg-[#a86b45]"
                                            }`}
                                    />
                            ...
                            {plans.map((item, index) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`text-left p-7 md:p-9 min-h-[330px] transition ${isSelected
                                                ? "bg-[#dfe5da]"
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start justify-between">
                                            ...
                                            <span
                                                className={`w-5 h-5 border flex items-center justify-center ${isSelected
                                ...
                                <button
                                    onClick={() =>
                                        navigate("/demo-payment", {
                                            state: {
                                                plan,
                                                amount: plans.find((item) => item.id === plan)?.price,
                                            },
                                        })
                                    }
                                    disabled={saving}
